...
if (! function_exists('plugins')) {
    ...
    function plugins($name, $base = 'vendor', $type = null)
    {
        ...
        if (! in_array($base, ['vendor', 'local'])) return false;
        ...
        if (is_array($rs['css'])) $rs['css'] = implode('', $rs['css']);
        if (is_array($rs['js'])) $rs['js'] = implode('', $rs['js']);
...
if (! function_exists('carbon')) {
    ...
    function carbon($datetime = null) {
        ...
        else $datetime = Carbon::parse($datetime);
